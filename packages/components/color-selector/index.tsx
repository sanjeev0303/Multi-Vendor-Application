      ...
      <Controller
        ...
        render={({ field }) => (
          <div className="flex gap-3 flex-wrap">
            {[...defaultColors, ...customColors].map((color) => {
              ...
              return (
                <button
                  ...
                  className={`w-7 h-7 p-2 rounded-md my-1 flex items-center justify-center  cursor-pointer border-2 transition  ${
            ...
            {/* Add New colors */}
            <button className="w-8 h-8 flex items-center justify-center rounded-full border-2 border-gray-500 bg-gray-800 hover:bg-gray-700 transition-colors duration-300"
            onClick={() => {
